...
Routine note: pick the single top unchecked item below, make the smallest safe
change that satisfies it, then check it off with today's date. Leave every
other line and every other file untouched.
...
- [x] Add a small counter that shows how many habits are checked off today (2026-09-23)
